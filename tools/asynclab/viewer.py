...
<style>
  ...
  * { box-sizing:border-box; margin:0; }
  ...
  /* 소스는 왼쪽 열 전체(2행)를 차지하고 화면에 붙어 따라온다 — 스크롤 최소화 */
  .srcpanel { grid-row:1 / span 2; position:sticky; top:12px; }
  .fullw { grid-column:1 / -1; }
  @media (max-width:1100px) { .grid { grid-template-columns:1fr; }
    .srcpanel { grid-row:auto; position:static; } .fullw { grid-column:auto; } }
